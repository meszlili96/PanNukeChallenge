...
class Config(object):
    def __init__(self, ):
        ...
        self.train_dir = ["/home/ccurs011/HoverNet/PanT/fold2/"] #['/home/ccurs011/fold1/256x256/']
        self.valid_dir = ["/home/ccurs011/HoverNet/PanT/fold1/"] #['/home/ccurs011/fold1/256x256/']
        ...
        self.log_path = '/home/ccurs011/HoverNet/linda_micronet/logs_split2/'
        ...
        self.inf_output_dir = '/home/ccurs011/HoverNet/linda_micronet/output_split2/%s/%s/' % (exp_id, model_id)
