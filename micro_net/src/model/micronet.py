...
class Graph(ModelDesc, Config):
    ...
    def _build_graph(self, inputs):
        ...
        def down_branch7(name, main_in, aux_in, ch):
            with tf.variable_scope(name):
                a = Conv2D('conv-2', main_in, ch, 3, padding='valid', use_bias=False, activation=BNReLU)
                a = Conv2D('conv-1', a, ch, 3, padding='valid', use_bias=False, activation=BNReLU)
                a = Conv2D('conv1', a, ch, 3, padding='valid', use_bias=False, activation=BNReLU)
        ...
        with argscope(Conv2D, activation=tf.identity, 
            ...
            ####
            b1 = down_branch7('b1',  i, resize_func(i, (128, 128)),  64)
