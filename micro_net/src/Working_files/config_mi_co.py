...
class Config(object):
    def __init__(self, ):
        ...
        self.nuclei_type_dict = {
             'Miscellaneous': 1,
	     #'Neo': 1, # ! Please ensure the matching ID is unique
            #'Inflammatory': 2,
            'Epithelial': 3,
	    #'Connective': 3,
            'Spindle': 4 
        ...
        #self.train_dir = ['/home/ccurs011/fold1/504x504_252x252']
        self.train_dir = ['/home/ccurs011/HoverNet/CoNSeP/trainpatches/%s/' % data_code_dict[self.model_type]]
        #self.valid_dir = ['/home/ccurs011/fold2/504x504_252x252']
        ...
        self.log_path = '/home/ccurs011/HoverNet/luca_micronet/src/media/consep_micro/logs/' # log root path - modify according to needs
        ...
        #self.inf_data_dir = '/home/ccurs011/fold1/Images/'
