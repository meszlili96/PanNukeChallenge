...
class Config(object):
    def __init__(self, ):
        ...
        self.seed = 10 
        mode = 'other' #hover
        self.model_type = 'micronet' #np_hv
        ...
        self.train_dir = ['/home/ccurs011/fold1/504x504_252x252_full/']
        #self.train_dir = ['/home/ccurs011/HoverNet/CoNSeP/trainpatches/%s/' % data_code_dict[self.model_type]]
        self.valid_dir = ['/home/ccurs011/fold2/504x504_252x252_full/']
        #self.valid_dir = ['/home/ccurs011/HoverNet/CoNSeP/testpatches/%s/' % data_code_dict[self.model_type]]
        ...
        #self.log_path = '/home/ccurs011/HoverNet/luca_micronet/src/media/panuke_micro/logs' # log root path - modify according to needs
        self.log_path = '/scratch-local/ccurs011/logs'
        ...
        self.inf_model_path  = self.save_dir + '/model-996.index'
        ...
        #self.inf_data_dir = '/home/ccurs011/HoverNet/CoNSeP/Test/Images/'
        self.inf_data_dir = '/home/ccurs011/fold3/Images_subset/'
    ...
    def get_train_augmentors(self, input_shape, output_shape, view=False):
        #print('get_train_augmentors: input_shape, output_shape')
    ...
    def get_valid_augmentors(self, input_shape, output_shape, view=False):
        #print('get valid augmentors: input shape, output_shape')
	#print(input_shape, output_shape)
	#print()
