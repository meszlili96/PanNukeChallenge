...
class Config(object):
    def __init__(self, ):
        ...
        # Our transform_pannuke.py script records cell type to fifths
        # HoverNet input channel in the order of PanNuke masks cells ids
        # Which means the following order of the class labels
        ...
        self.train_dir = ['/home/ccurs011/HoverNet/PanT/fold3/']
        ...
        self.log_path = '/home/ccurs011/HoverNet/hover_net/hovernet_logs_split3/' #'/media/vqdang/logs/' # log root path - modify according to needs
        ...
        self.inf_output_dir = '/home/ccurs011/HoverNet/hover_net/output_split3/%s/%s/' % (exp_id, model_id)
