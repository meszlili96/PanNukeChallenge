...
class Config(object):
    def __init__(self, ):
        ...
        self.train_dir = ['/home/ccurs011/HoverNet/PanT/fold2/']
        self.valid_dir = ['/home/ccurs011/HoverNet/PanT/fold1/']
        ...
        self.log_path = '/home/ccurs011/HoverNet/hover_net/hovernet_logs_split2/' #'/media/vqdang/logs/' # log root path - modify according to needs
        ...
        self.inf_output_dir = '/home/ccurs011/HoverNet/hover_net/output_split2/%s/%s/' % (exp_id, model_id)
